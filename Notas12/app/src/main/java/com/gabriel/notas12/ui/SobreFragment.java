...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String descricao = "Notas 1.2 é a última versão do aplicativo de notas. " +
                "Nesta versão é possível vizualizar notas em lista separadas entre notas e lembretes; " +
                "Adicionar editar ou remover notas; AplicarRecuperar notas da lixeira; Aplicar filtros e fazer buscas; " +
                "Configurar o comportamento do app.";

        Element versao = new Element();
        versao.setTitle("Versão 1.2");
        ...
        View view = new AboutPage(getActivity())
                ...
                .addEmail("contato@notas.com.br", "Envie um e-mail")
